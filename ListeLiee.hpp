...
// Classe représentant un nœud dans une liste chaînée doublement chaînée.
template<typename T>
class Noeud
{
...
private:
    T donnee_;                  // Les données contenues dans ce nœud
    Noeud<T>* suivant_;         // Pointeur vers le nœud suivant
    Noeud<T>* precedent_;       // Pointeur vers le nœud précédent
};

// Classe représentant un itérateur pour une liste chaînée doublement chaînée.
template<typename T>
class Iterateur
{
    friend class ListeLiee<T>;
...
private:
    Noeud<T>* position_;    // Pointeur vers le nœud actuel
};

// Classe représentant une liste chaînée doublement chaînée.
template<typename T>
class ListeLiee
{
    friend class Iterateur<T>;
...
private:
    gsl::owner<Noeud<T>*> tete_;   // Pointeur vers le premier nœud
    Noeud<T>* queue_;              // Pointeur vers le dernier nœud
    unsigned taille_;              // Nombre de nœuds dans la liste
};